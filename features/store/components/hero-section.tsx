...
export function HeroSection() {
  return (
    <section className="relative w-full min-h-125 md:min-h-150 lg:min-h-175 flex items-center bg-[#3e4934] text-[#fff9ed] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-[#3e4934]/95 via-[#3e4934]/60 to-transparent z-10 md:hidden pointer-events-none" />

      {/* Content */}
      <div className="relative z-20 w-full px-5 md:px-16 max-w-7xl mx-auto flex flex-col justify-center py-12 md:py-16">
        <div className="max-w-md md:max-w-lg lg:max-w-xl md:mt-8">
          ...
          <p className="text-[16px] md:text-[18px] leading-6.5 md:leading-7 text-[#e8e2d4] mb-8 max-w-sm md:max-w-md">
          ...
          >
            Shop Now <ArrowRight className="ml-2 w-4.5 h-4.5" />
          </Link>
        </div>
      </div>
    </section>
